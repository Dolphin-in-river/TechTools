...
В данном задании было создано 2 функции. 1-я - FileStart - для работы с реальной файловой системой, 2-я - VirualStart - без нее. 
...
Анализируя распределение по Call Tree можно увидеть, что процент затраченных ресурсов на FileStart равен 90.0.
На VirualStart 9.52%.
...
Из 9.52% только около 1% пошло на создание точки, примерно столько же на удаление. 

Более 80% ресурсов были затрачены на работу с файлами и менее 20% ресурсов использовались для другого. 
