...
Из 9.52% в MemoryStart только около 1% пошло на создание точки, примерно столько же на удаление. 

Более 80% ресурсов были затрачены на работу с файлами (создание архива, удаление архивов), также из 20% свободных ресурсов для самой программы большая часть уходит на логгирование.
